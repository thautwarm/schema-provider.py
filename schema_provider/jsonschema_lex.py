...
EOF = 1
BOF = 0
REGEX = '(\\s+)|(\\#.*)|([a-zA-Z_][a-zA-Z_0-9]*)|("([^\\\\"]+|\\\\.)*?")|([-+]?[0-9]+\\.\\d+([eE][-+]?\\d+)?|[-+]?[0-9]+[eE][-+]?\\d+)|([-+]?[0-9]+)|(\\})|(\\|)|(\\{)|(\\])|(\\\\schema)|(\\[)|(=)|(:)|(\\.)|(,)|(\\*\\*)|(\\*)'
REGEX_STR = __import__('re').compile(REGEX)
REGEX_BYTES = __import__('re').compile(REGEX.encode())
IGNORES = (18, 19)
UNIONALL_INFO = ((None, None), (18, None), (19, None), (3, None), (13, None), (None, None), (14, None), (None, None), (12, None), (6, None), (10, None), (5, None), (8, None), (2, None), (7, None), (4, None), (15, None), (9, None), (11, None), (16, None), (17, None))
UNIONALL_INFO_BYTES = ((None, None), (18, None), (19, None), (3, None), (13, None), (None, None), (14, None), (None, None), (12, None), (6, None), (10, None), (5, None), (8, None), (2, None), (7, None), (4, None), (15, None), (9, None), (11, None), (16, None), (17, None))
numbering = {'BOF': 0, 'EOF': 1, 'quote \\schema': 2, 'ident': 3, 'quote =': 4, 'quote {': 5, 'quote }': 6, 'quote [': 7, 'quote ]': 8, 'quote .': 9, 'quote |': 10, 'quote ,': 11, 'int': 12, 'str': 13, 'float': 14, 'quote :': 15, 'quote **': 16, 'quote *': 17, 'space': 18, 'comment': 19}
